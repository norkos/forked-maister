...
**IMPORTANT**: Do NOT write any files to disk. The maister-fork:init command will use your returned analysis to generate proper documentation in `.maister/docs/`.
