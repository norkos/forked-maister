---
name: maister-fork:reviews-code
...
```
User: /maister-fork:reviews-code .maister/tasks/development/2025-10-24-auth/
```

**Example 2**: Review with specific scope
```
User: /maister-fork:reviews-code src/api/ --scope=security
```

**Example 3**: Review entire project
```
User: /maister-fork:reviews-code src/
```
