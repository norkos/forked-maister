...
|----------------|-------------------|
| development | `maister-fork:development` |
| performance | `maister-fork:performance` |
| research | `maister-fork:research` |
| product-design | `maister-fork:product-design` |
...
```
Use Skill tool:
  skill: "maister-fork:[orchestrator-name]"
  args: "--resume [task_path] [flags]"
```

Examples:
- Resume development: `skill: "maister-fork:development"` with `args: "--resume .maister/tasks/development/2025-10-23-fix"`
- Restart from phase: `skill: "maister-fork:development"` with `args: "--resume .maister/tasks/development/2025-10-26-auth --from=verify"`
- Fresh attempts: `skill: "maister-fork:development"` with `args: "--resume .maister/tasks/development/2025-10-20-redux --reset-attempts"`
...
```
Use Task tool:
  subagent_type: "maister-fork:task-classifier"
...
**Routing examples:**
- development (92%): `skill: "maister-fork:development"` with `args: "Fix login timeout error"`
- development (88%): `skill: "maister-fork:development"` with `args: "Add filtering to user table"`
- performance (95%): `skill: "maister-fork:performance"` with `args: "Optimize slow dashboard queries"`
...
- Use specific workflow commands directly:
  /maister-fork:development, /maister-fork:performance, etc."
```
...
|---------------|-------|------|
| development | `maister-fork:development` | `--resume [path] [--from=PHASE] [--reset-attempts]` |
| performance | `maister-fork:performance` | `--resume [path] [--from=PHASE]` |
| research | `maister-fork:research` | `--resume [path] [--from=PHASE]` |
| product-design | `maister-fork:product-design` | `--resume [path] [--from=PHASE]` |
