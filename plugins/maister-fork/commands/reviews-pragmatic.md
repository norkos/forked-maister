...
```
User: /maister-fork:reviews-pragmatic .maister/tasks/development/2025-11-17-user-management/
```

**Example 2**: Review source directory
```
User: /maister-fork:reviews-pragmatic src/features/payments/
```

**Example 3**: Review specific file
```
User: /maister-fork:reviews-pragmatic src/services/cache-service.ts
```
