...
- subagent_type: `maister-fork:test-suite-runner`
...
- subagent_type: `maister-fork:implementation-completeness-checker`
...
- subagent_type: `maister-fork:code-reviewer`
...
- subagent_type: `maister-fork:code-quality-pragmatist`
...
- subagent_type: `maister-fork:production-readiness-checker`
...
- subagent_type: `maister-fork:reality-assessor`
...
- ❌ Running Bash commands to execute tests → Use Task tool with `maister-fork:test-suite-runner`
- ❌ Reading implementation-plan.md to check completion → Use Task tool with `maister-fork:implementation-completeness-checker`
- ❌ Reading INDEX.md to check standards compliance → Use Task tool with `maister-fork:implementation-completeness-checker`
- ❌ Reading source code for quality/security analysis → Use Task tool with `maister-fork:code-reviewer`
- ❌ Checking config/monitoring/resilience directly → Use Task tool with `maister-fork:production-readiness-checker`
