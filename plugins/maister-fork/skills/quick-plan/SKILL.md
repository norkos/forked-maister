...
3. **Discover and enforce standards (the addition)** — While planning:
   ...
   If `.maister/docs/INDEX.md` does not exist, plan normally and note in the plan: "No Maister standards found. Consider running `/maister-fork:init`."
