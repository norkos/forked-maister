...
**INVOKE NOW**: Use Task tool with `subagent_type: maister-fork:research-planner`
...
**INVOKE NOW**: Use Task tool with `subagent_type: maister-fork:research-synthesizer`
...
**INVOKE NOW**: Use Task tool with `subagent_type: maister-fork:solution-brainstormer`
...
**INVOKE NOW**: Use Task tool with `subagent_type: maister-fork:solution-designer`
...
**Command**: `/maister-fork:research [research-question]`
...
Invoked via:
- `/maister-fork:research [question] [--type=TYPE] [--brainstorm] [--no-brainstorm] [--design] [--no-design]` (new)
- `/maister-fork:research [task-path] [--from=PHASE]` (resume)
